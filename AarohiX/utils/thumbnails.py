...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        font = ImageFont.truetype("AarohiX/font2.ttf", 45)
        ImageFont.truetype("AarohiX/font2.ttf", 70)
        arial = ImageFont.truetype("AarohiX/font2.ttf", 30)
        ImageFont.truetype("AarohiX/font.ttf", 30)
...
async def que_thumb(videoid, user_id):
    ...
    try:
        ...
        border = random.choice(colors)
        youtube = Image.open(f"cache/thumb{videoid}.png")
        bg = Image.open(f"AarohiX/{images}.png")
        image1 = changeImageSize(1280, 720, youtube)
        image2 = image1.convert("RGBA")
        background = image2.filter(filter=ImageFilter.BoxBlur(30))
        enhancer = ImageEnhance.Brightness(background)
