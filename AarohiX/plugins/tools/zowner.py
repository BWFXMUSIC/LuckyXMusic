...
from AarohiX.utils.decorators.userbotjoin import UserbotWrapper
from AarohiX.utils.database import get_assistant, is_active_chat
...
async def help(client: Client, message: Message):
    await message.reply_video(
        video=f"https://te.legra.ph/file/d27b1935cfb59ae73ef35.mp4",
